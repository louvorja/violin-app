export const ICONS = {
  ...
  ACTIONS: {
    ...
    NEXT_BOLD: "mdi-arrow-right-bold",
    PREVIOUS: "mdi-chevron-left",
    PREVIOUS_BOLD: "mdi-arrow-left-bold",
    redo: "mdi-redo",
    REFRESH: "mdi-refresh",
    RENAME: "mdi-rename",
    RESTART: "mdi-restart",
    ...
    SEARCH: "mdi-magnify",
    SELECT_MULTIPLE: "mdi-checkbox-multiple-marked-outline",
    SORT: "mdi-swap-horizontal",
    SPLIT: "mdi-arrow-split-horizontal",
    START: "mdi-power",
    STOP: "mdi-power-off",
  ...
  CALENDAR: {
    ...
    BLANK_SOLID: "mdi-calendar-blank",
  ...
  MEDIA: {
    ...
    PLAYLIST: "mdi-playlist-play",
    TELEVISION_PLAY: "mdi-television-play",
    VIDEO: "mdi-video-outline",
    VIDEO_FILE: "mdi-video",
    YOUTUBE: "mdi-youtube",
  },
  MODULES: {
  ...
  MUSIC: {
    ...
    CLEF: "mdi-music-clef-treble",
    FILE: "mdi-file-music-outline",
    FOLDER: "mdi-folder-music",
    LYRIC: "mdi-text-box-outline",
    MICROPHONE: "mdi-microphone-variant",
    MUSIC: "mdi-music",
    NOTE: "mdi-music-note",
    NOTE_EIGHTH: "mdi-music-note-eighth",
    NOTE_OUTLINE: "mdi-music-note-outline",
    NO_AUDIO: "mdi-music-note-off",
    OFF: "mdi-music-off",
    PIANO: "mdi-piano",
    PLAYBACK: "mdi-music-box-outline",
    PLAYBACK_MULTIPLE: "mdi-music-box-multiple",
    SING: "mdi-music-box",
    SLIDES_AUDIO: "mdi-play-box-multiple",
    SLIDES_ONLY: "mdi-checkbox-multiple-blank-outline",
    SLIDES_PLAYBACK: "mdi-play-box-multiple-outline",
    SUNG: "mdi-account-voice",
    VINYL: "mdi-album",
  },
  PLAYER: {
    ...
    LOOP: "mdi-repeat",
    LOOP_OFF: "mdi-repeat-off",
    NEXT: "mdi-skip-next",
    PAGE_FIRST: "mdi-page-first",
    PAGE_LAST: "mdi-page-last",
    PAUSE: "mdi-pause-circle",
    /** Pausa sem círculo — par de PLAYER ("mdi-play"); usado no player do rodapé. */
    PAUSE_PLAIN: "mdi-pause",
    ...
    PLAY_OUTLINE: "mdi-play-circle-outline",
  ...
  PROJECTION: {
    ...
    PRESENT: "mdi-presentation-play",
    PRESENTATION: "mdi-presentation",
    RETURN: "mdi-monitor-eye",
    SCREEN: "mdi-projector-screen",
    SCREEN_OUTLINE: "mdi-projector-screen-outline",
    START: "mdi-monitor",
  ...
  UI: {
    ...
    OPTIONS: "mdi-cog",
    OPTIONS_OUTLINE: "mdi-cog-outline",
